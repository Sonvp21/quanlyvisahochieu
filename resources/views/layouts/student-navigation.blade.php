<nav x-data="{ open: false }" id="studentNavbar" class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 transition-all duration-300 ease-in-out">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('student.dashboard') }}" class="flex items-center gap-3">
                        <img src="{{ asset('images/logo.jpg') }}" alt="Student Portal Logo" class="h-12 w-auto">
                        <span class="text-xl font-bold text-gray-800">Sinh Viên Portal</span>
                    </a>
                </div>
