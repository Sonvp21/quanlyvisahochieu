        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('admin.dashboard') }}" class="hover:text-blue-600 transition">Trang chủ</a>
                    </li>
                    <li><a href="{{ route('admin.students.index') }}" class="hover:text-blue-600 transition">Quản lý sinh viên</a>
                    </li>
                    <li><a href="{{ route('admin.notification-reports.index') }}" class="hover:text-blue-600 transition">Quản lý email</a>
                    </li>
                </ul>
            </div>
